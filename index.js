import{B as f}from"./assets/api-CERUV-tc.js";document.addEventListener("DOMContentLoaded",()=>{const t=document.querySelector(".menu-button"),s=t.querySelector(".icon"),c=document.querySelector(".modal"),u=document.querySelectorAll(".menu-list-item"),i=document.querySelector(".header");let n=!1;const a=`
