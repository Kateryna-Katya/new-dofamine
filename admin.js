import{g as h,c as w,a as s}from"./assets/api-CIPiVqkG.js";const c="/new-dofamine/";h()||(window.location.href=`${c}login.html`);const l=document.querySelector("#productsList"),t=document.querySelector("#createForm"),y=document.querySelector("#logoutBtn");y.addEventListener("click",()=>{w(),window.location.href=`${c}login.html`});async function i(){const o=await s("/products");l.innerHTML="",o.forEach(e=>{const n=document.createElement("li");n.innerHTML=`
      <b>${e.name}</b>
